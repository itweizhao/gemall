...
public class OssController {
    ...
    public Resp<Object> policy(){
        String accessId = "LTAI4Ft4g86bGxj63cwKPGur"; // 请填写您的AccessKeyId。
        String accessKey = "EG3QNo1vQwfmaVj87qUX804kJ2BQ00"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gmallw"; // 请填写您的 bucketname 。
