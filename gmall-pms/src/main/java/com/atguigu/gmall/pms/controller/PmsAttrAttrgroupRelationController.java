...
public class PmsAttrAttrgroupRelationController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('pms:pmsattrattrgrouprelation:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('pms:pmsattrattrgrouprelation:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('pms:pmsattrattrgrouprelation:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('pms:pmsattrattrgrouprelation:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('pms:pmsattrattrgrouprelation:delete')")
