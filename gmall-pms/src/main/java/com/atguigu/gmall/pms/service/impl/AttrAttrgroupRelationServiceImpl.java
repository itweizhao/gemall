...
public class AttrAttrgroupRelationServiceImpl extends ServiceImpl<AttrAttrgroupRelationDao, AttrAttrgroupRelationEntity> implements AttrAttrgroupRelationService {
    ...
    @Override
    public void deleteAll(List<AttrAttrgroupRelationEntity> relationEntities) {
        relationEntities.forEach(relationEntitie -> {
            this.remove(new QueryWrapper<AttrAttrgroupRelationEntity>()
                    .eq("attr_id",relationEntitie.getAttrId())
                    .eq("attr_group_id",relationEntitie.getAttrGroupId())
                    );
        });
    }
